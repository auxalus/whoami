...
<body class="h-full w-full overflow-hidden bg-[#FAFAFA] text-[#000000] font-mono no-select">
  ...
  <script type="text/babel">
    ...
    function App() {
      ...
      // --- START SCREEN SCROLL DISMISSAL LISTENER ---
      useEffect(() => {
        if (!showIntro) return;
      ...
      return (
        <div className="relative w-full h-full overflow-hidden bg-[#FAFAFA] text-[#000000]">
          ...
          {showIntro && (
            <div
              className="fixed inset-0 z-50 bg-[#FAFAFA] text-[#000000] font-mono flex flex-col justify-between p-6 md:p-12 animate-page select-none"
            >
              ...
              <div className="max-w-2xl mx-auto text-center px-4 my-auto space-y-7 animate-fadeIn">
                ...
                <div className="space-y-5 text-[13px] md:text-sm leading-relaxed text-neutral-900 font-mono">
                  ...
                  <p className="text-[12px] md:text-[13px] text-neutral-500">
                    {lang === 'es'
                      ? '197 historias ilustradas es un proyecto que busca compartir la vida cotidiana de cada una de las personas detenidas desaparecidas.'
                      : '197 illustrated stories is a project that seeks to share the everyday lives and memories of each of the people forcibly disappeared.'}
                  </p>
                </div>
                ...
                <div className="pt-2 flex flex-col items-center gap-2">
                  ...
                  <span className="text-[10px] text-neutral-400 tracking-widest uppercase pt-1">
                    ↓ {lang === 'es' ? 'desplázate para entrar' : 'scroll to enter'}
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between text-[11px] md:text-xs tracking-wider uppercase text-neutral-400">
                ...
                <div className="flex items-center space-x-2 text-[13px] text-black font-mono">
                  <button
                    onClick={() => setLang('es')}
                    className={'hover:text-black transition-colors ' + (lang === 'es' ? 'font-bold underline underline-offset-4 decoration-1' : 'text-neutral-500')}
                  >
                    ES
                  </button>
                  ...
                  <button
                    onClick={() => setLang('en')}
                    className={'hover:text-black transition-colors ' + (lang === 'en' ? 'font-bold underline underline-offset-4 decoration-1' : 'text-neutral-500')}
                  >
                    EN
                  </button>
                </div>
